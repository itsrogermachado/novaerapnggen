    ...
    <header className="border-b border-border/60 bg-card/90 backdrop-blur-sm sticky top-0 z-50 transition-all duration-200">
      ...
      <div className="max-w-7xl mx-auto px-4 py-2.5 flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-2 sm:gap-3 shrink-0">
          ...
          <div className="flex items-center gap-2 bg-muted/50 border border-border/40 rounded-sm pl-2 pr-3 py-1 text-xs sm:text-sm font-medium text-muted-foreground hidden md:flex hover:text-foreground hover:bg-muted/80 transition-all cursor-default">
            <div className="w-5 h-5 rounded-sm bg-primary text-primary-foreground flex items-center justify-center font-bold text-[10px] uppercase">
          ...
          <Button
            ...
            size="sm"
            onClick={onLogout}
            className="border-border hover:bg-muted cursor-pointer rounded-sm flex items-center gap-1"
          >
